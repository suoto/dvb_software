...
bool is_config_valid( FrameParameters* parms ) {
  vector< FrameParameters* > valid_configs = {
      new FrameParameters{ FECFRAME_SHORT, MOD_32APSK, C3_4 },
      new FrameParameters{ FECFRAME_SHORT, MOD_8PSK, C2_3 },
      new FrameParameters{ FECFRAME_NORMAL, MOD_QPSK, C5_6 },
      new FrameParameters{ FECFRAME_NORMAL, MOD_QPSK, C8_9 },
      new FrameParameters{ FECFRAME_NORMAL, MOD_16APSK, C5_6 },
      new FrameParameters{ FECFRAME_NORMAL, MOD_32APSK, C8_9 },
      new FrameParameters{ FECFRAME_NORMAL, MOD_32APSK, C5_6 },
      new FrameParameters{ FECFRAME_NORMAL, MOD_QPSK, C1_4 },
      new FrameParameters{ FECFRAME_NORMAL, MOD_16APSK, C3_4 },
      new FrameParameters{ FECFRAME_SHORT, MOD_8PSK, C3_5 },
      new FrameParameters{ FECFRAME_NORMAL, MOD_QPSK, C3_4 },
      new FrameParameters{ FECFRAME_NORMAL, MOD_8PSK, C9_10 },
      new FrameParameters{ FECFRAME_SHORT, MOD_8PSK, C8_9 },
      new FrameParameters{ FECFRAME_SHORT, MOD_QPSK, C1_3 },
      new FrameParameters{ FECFRAME_SHORT, MOD_32APSK, C5_6 },
      new FrameParameters{ FECFRAME_SHORT, MOD_QPSK, C1_2 },
      new FrameParameters{ FECFRAME_SHORT, MOD_16APSK, C8_9 },
      new FrameParameters{ FECFRAME_SHORT, MOD_QPSK, C2_5 },
      new FrameParameters{ FECFRAME_NORMAL, MOD_QPSK, C1_3 },
      new FrameParameters{ FECFRAME_NORMAL, MOD_QPSK, C2_3 },
      new FrameParameters{ FECFRAME_SHORT, MOD_32APSK, C8_9 },
      new FrameParameters{ FECFRAME_NORMAL, MOD_QPSK, C1_2 },
      new FrameParameters{ FECFRAME_SHORT, MOD_8PSK, C5_6 },
      new FrameParameters{ FECFRAME_SHORT, MOD_QPSK, C3_5 },
      new FrameParameters{ FECFRAME_SHORT, MOD_QPSK, C4_5 },
      new FrameParameters{ FECFRAME_SHORT, MOD_QPSK, C2_3 },
      new FrameParameters{ FECFRAME_SHORT, MOD_8PSK, C3_4 },
      new FrameParameters{ FECFRAME_NORMAL, MOD_16APSK, C4_5 },
      new FrameParameters{ FECFRAME_NORMAL, MOD_16APSK, C8_9 },
      new FrameParameters{ FECFRAME_NORMAL, MOD_16APSK, C9_10 },
      new FrameParameters{ FECFRAME_NORMAL, MOD_8PSK, C8_9 },
      new FrameParameters{ FECFRAME_SHORT, MOD_16APSK, C3_4 },
      new FrameParameters{ FECFRAME_NORMAL, MOD_8PSK, C3_4 },
      new FrameParameters{ FECFRAME_NORMAL, MOD_32APSK, C4_5 },
      new FrameParameters{ FECFRAME_SHORT, MOD_QPSK, C8_9 },
      new FrameParameters{ FECFRAME_NORMAL, MOD_QPSK, C4_5 },
      new FrameParameters{ FECFRAME_NORMAL, MOD_8PSK, C3_5 },
      new FrameParameters{ FECFRAME_SHORT, MOD_16APSK, C4_5 },
      new FrameParameters{ FECFRAME_NORMAL, MOD_8PSK, C2_3 },
      new FrameParameters{ FECFRAME_SHORT, MOD_QPSK, C5_6 },
      new FrameParameters{ FECFRAME_SHORT, MOD_16APSK, C5_6 },
      new FrameParameters{ FECFRAME_NORMAL, MOD_8PSK, C5_6 },
      new FrameParameters{ FECFRAME_SHORT, MOD_32APSK, C4_5 },
      new FrameParameters{ FECFRAME_NORMAL, MOD_32APSK, C9_10 },
      new FrameParameters{ FECFRAME_NORMAL, MOD_QPSK, C2_5 },
      new FrameParameters{ FECFRAME_SHORT, MOD_QPSK, C1_4 },
      new FrameParameters{ FECFRAME_SHORT, MOD_QPSK, C3_4 },
      new FrameParameters{ FECFRAME_NORMAL, MOD_32APSK, C3_4 },
      new FrameParameters{ FECFRAME_SHORT, MOD_16APSK, C2_3 },
      new FrameParameters{ FECFRAME_NORMAL, MOD_QPSK, C3_5 },
      new FrameParameters{ FECFRAME_NORMAL, MOD_16APSK, C2_3 },
      new FrameParameters{ FECFRAME_NORMAL, MOD_QPSK, C9_10 },
      new FrameParameters{ FECFRAME_SHORT, MOD_32APSK, C3_4 },
      new FrameParameters{ FECFRAME_SHORT, MOD_8PSK, C2_3 },
      new FrameParameters{ FECFRAME_NORMAL, MOD_QPSK, C5_6 },
      new FrameParameters{ FECFRAME_NORMAL, MOD_QPSK, C8_9 },
  ...
  for ( size_t i = 0; i < valid_configs.size(); i++ ) {
    const FrameParameters* candidate = valid_configs.at( i );
    if ( candidate->frame_size == parms->frame_size &&
         candidate->constellation == parms->constellation &&
         candidate->code_rate == parms->code_rate ) {
      SPDLOG_INFO( "{} == {}", format( parms ),
                   format( valid_configs.at( i ) ) );
      return 1;
    } else {
      SPDLOG_INFO( "{} != {}", format( parms ),
                   format( valid_configs.at( i ) ) );
  ...
  // return ( std::find( valid_configs.begin(), valid_configs.end(), parms ) !=
  //          valid_configs.end() );
};
...
int main( int argc, char* argv[] ) {
  ...
  if ( !is_config_valid( parms ) ) {
    SPDLOG_ERROR( "Specified configuration is invalid" );
    FATAL;
    return -1;
  };
