...
int main() {
  ...
  gr_complex *modulation_table, *table;
  std::vector<gr_complex> _table;

  dvb_constellation_t constellation = MOD_32APSK;
  dvb_framesize_t framesize = FECFRAME_NORMAL;
  dvb_code_rate_t rate = C9_10;
  ...
  switch ( constellation ) {
    case MOD_QPSK:
      modulation_table = (gr_complex*)malloc( 4 * sizeof( gr_complex ) );
      table = modulation_table;

      *table++ = gr_complex( ( r1 * cos( GR_M_PI / 4.0 ) ),
                             ( r1 * sin( GR_M_PI / 4.0 ) ) );
      *table++ = gr_complex( ( r1 * cos( 7 * GR_M_PI / 4.0 ) ),
                             ( r1 * sin( 7 * GR_M_PI / 4.0 ) ) );
      *table++ = gr_complex( ( r1 * cos( 3 * GR_M_PI / 4.0 ) ),
                             ( r1 * sin( 3 * GR_M_PI / 4.0 ) ) );
      *table++ = gr_complex( ( r1 * cos( 5 * GR_M_PI / 4.0 ) ),
                             ( r1 * sin( 5 * GR_M_PI / 4.0 ) ) );
      break;
    case MOD_8PSK:
      modulation_table = (gr_complex*)malloc( 8 * sizeof( gr_complex ) );
      table = modulation_table;
      *table++ = gr_complex( ( r1 * cos( GR_M_PI / 4.0 ) ),
                             ( r1 * sin( GR_M_PI / 4.0 ) ) );
      *table++ = gr_complex( ( r1 * cos( 0.0 ) ), ( r1 * sin( 0.0 ) ) );
      *table++ = gr_complex( ( r1 * cos( 4 * GR_M_PI / 4.0 ) ),
                             ( r1 * sin( 4 * GR_M_PI / 4.0 ) ) );
      *table++ = gr_complex( ( r1 * cos( 5 * GR_M_PI / 4.0 ) ),
                             ( r1 * sin( 5 * GR_M_PI / 4.0 ) ) );
      *table++ = gr_complex( ( r1 * cos( 2 * GR_M_PI / 4.0 ) ),
                             ( r1 * sin( 2 * GR_M_PI / 4.0 ) ) );
      *table++ = gr_complex( ( r1 * cos( 7 * GR_M_PI / 4.0 ) ),
                             ( r1 * sin( 7 * GR_M_PI / 4.0 ) ) );
      *table++ = gr_complex( ( r1 * cos( 3 * GR_M_PI / 4.0 ) ),
                             ( r1 * sin( 3 * GR_M_PI / 4.0 ) ) );
      *table++ = gr_complex( ( r1 * cos( 6 * GR_M_PI / 4.0 ) ),
                             ( r1 * sin( 6 * GR_M_PI / 4.0 ) ) );
      break;

    case MOD_16APSK:
      modulation_table = (gr_complex*)malloc( 16 * sizeof( gr_complex ) );
      table = modulation_table;
      r2 = m;
      ...
      r1 *= r0;
      r2 *= r0;
      *table++ = gr_complex( ( r2 * cos( GR_M_PI / 4.0 ) ),
                             ( r2 * sin( GR_M_PI / 4.0 ) ) );
      *table++ = gr_complex( ( r2 * cos( -GR_M_PI / 4.0 ) ),
                             ( r2 * sin( -GR_M_PI / 4.0 ) ) );
      *table++ = gr_complex( ( r2 * cos( 3 * GR_M_PI / 4.0 ) ),
                             ( r2 * sin( 3 * GR_M_PI / 4.0 ) ) );
      *table++ = gr_complex( ( r2 * cos( -3 * GR_M_PI / 4.0 ) ),
                             ( r2 * sin( -3 * GR_M_PI / 4.0 ) ) );
      *table++ = gr_complex( ( r2 * cos( GR_M_PI / 12.0 ) ),
                             ( r2 * sin( GR_M_PI / 12.0 ) ) );
      *table++ = gr_complex( ( r2 * cos( -GR_M_PI / 12.0 ) ),
                             ( r2 * sin( -GR_M_PI / 12.0 ) ) );
      *table++ = gr_complex( ( r2 * cos( 11 * GR_M_PI / 12.0 ) ),
                             ( r2 * sin( 11 * GR_M_PI / 12.0 ) ) );
      *table++ = gr_complex( ( r2 * cos( -11 * GR_M_PI / 12.0 ) ),
                             ( r2 * sin( -11 * GR_M_PI / 12.0 ) ) );
      *table++ = gr_complex( ( r2 * cos( 5 * GR_M_PI / 12.0 ) ),
                             ( r2 * sin( 5 * GR_M_PI / 12.0 ) ) );
      *table++ = gr_complex( ( r2 * cos( -5 * GR_M_PI / 12.0 ) ),
                             ( r2 * sin( -5 * GR_M_PI / 12.0 ) ) );
      *table++ = gr_complex( ( r2 * cos( 7 * GR_M_PI / 12.0 ) ),
    ...
    case MOD_32APSK:
      modulation_table = (gr_complex*)malloc( 32 * sizeof( gr_complex ) );
      table = modulation_table;
      r3 = m;
      switch ( rate ) {
        case C3_4:
      ...
      *table++ = gr_complex( ( r2 * cos( -7 * GR_M_PI / 12.0 ) ),
                             ( r2 * sin( -7 * GR_M_PI / 12.0 ) ) );
      *table++ = gr_complex( ( r3 * cos( GR_M_PI / 8.0 ) ),
                             ( r3 * sin( GR_M_PI / 8.0 ) ) );
      *table++ = gr_complex( ( r3 * cos( 3 * GR_M_PI / 8.0 ) ),
                             ( r3 * sin( 3 * GR_M_PI / 8.0 ) ) );
      *table++ = gr_complex( ( r3 * cos( -GR_M_PI / 4.0 ) ),
                             ( r3 * sin( -GR_M_PI / 4.0 ) ) );
      *table++ = gr_complex( ( r3 * cos( -GR_M_PI / 2.0 ) ),
                             ( r3 * sin( -GR_M_PI / 2.0 ) ) );
      *table++ = gr_complex( ( r3 * cos( 3 * GR_M_PI / 4.0 ) ),
                             ( r3 * sin( 3 * GR_M_PI / 4.0 ) ) );
      *table++ = gr_complex( ( r3 * cos( GR_M_PI / 2.0 ) ),
                             ( r3 * sin( GR_M_PI / 2.0 ) ) );
      *table++ = gr_complex( ( r3 * cos( -7 * GR_M_PI / 8.0 ) ),
                             ( r3 * sin( -7 * GR_M_PI / 8.0 ) ) );
      *table++ = gr_complex( ( r3 * cos( -5 * GR_M_PI / 8.0 ) ),
      ...
      *table++ = gr_complex( ( r1 * cos( -3 * GR_M_PI / 4.0 ) ),
                             ( r1 * sin( -3 * GR_M_PI / 4.0 ) ) );
      *table++ = gr_complex( ( r3 * cos( 0.0 ) ), ( r3 * sin( 0.0 ) ) );
      *table++ = gr_complex( ( r3 * cos( GR_M_PI / 4.0 ) ),
                             ( r3 * sin( GR_M_PI / 4.0 ) ) );
      *table++ = gr_complex( ( r3 * cos( -GR_M_PI / 8.0 ) ),
                             ( r3 * sin( -GR_M_PI / 8.0 ) ) );
      ...
      *table++ = gr_complex( ( r3 * cos( 5 * GR_M_PI / 8.0 ) ),
                             ( r3 * sin( 5 * GR_M_PI / 8.0 ) ) );
      *table++ = gr_complex( ( r3 * cos( GR_M_PI ) ), ( r3 * sin( GR_M_PI ) ) );
      *table++ = gr_complex( ( r3 * cos( -3 * GR_M_PI / 4.0 ) ),
                             ( r3 * sin( -3 * GR_M_PI / 4.0 ) ) );
      break;
  ...
  spdlog::info( "Modulation table:" );
  for ( int i = 0; i < 32; i++ ) {
    spdlog::info( "modulation[{}] = {}, {}", i, modulation_table[ i ].real(),
                  modulation_table[ i ].imag() );
  };

  // switch ( constellation ) {
  //   case MOD_QPSK:
  //     *modulation_table = {gr_complex( ( r1 * cos( GR_M_PI / 4.0 ) ),
  //                                      ( r1 * sin( GR_M_PI / 4.0 ) ) ),
  ...
  //     break;
  //   case MOD_8PSK:
  //     m_8psk[ 0 ] = gr_complex( ( r1 * cos( GR_M_PI / 4.0 ) ),
  //                               ( r1 * sin( GR_M_PI / 4.0 ) ) );
  //     m_8psk[ 1 ] = gr_complex( ( r1 * cos( 0.0 ) ), ( r1 * sin( 0.0 ) ) );
  //     m_8psk[ 2 ] = gr_complex( ( r1 * cos( 4 * GR_M_PI / 4.0 ) ),
  //                               ( r1 * sin( 4 * GR_M_PI / 4.0 ) ) );
  //     m_8psk[ 3 ] = gr_complex( ( r1 * cos( 5 * GR_M_PI / 4.0 ) ),
  //                               ( r1 * sin( 5 * GR_M_PI / 4.0 ) ) );
  //     m_8psk[ 4 ] = gr_complex( ( r1 * cos( 2 * GR_M_PI / 4.0 ) ),
  //                               ( r1 * sin( 2 * GR_M_PI / 4.0 ) ) );
  //     m_8psk[ 5 ] = gr_complex( ( r1 * cos( 7 * GR_M_PI / 4.0 ) ),
  //                               ( r1 * sin( 7 * GR_M_PI / 4.0 ) ) );
  //     m_8psk[ 6 ] = gr_complex( ( r1 * cos( 3 * GR_M_PI / 4.0 ) ),
  //                               ( r1 * sin( 3 * GR_M_PI / 4.0 ) ) );
  //     m_8psk[ 7 ] = gr_complex( ( r1 * cos( 6 * GR_M_PI / 4.0 ) ),
  //                               ( r1 * sin( 6 * GR_M_PI / 4.0 ) ) );
  //     break;
  //   case MOD_8APSK:
  //     r3 = m;
  ...
  //     }
  //     m_8psk[ 0 ] =
  //         gr_complex( ( r1 * cos( GR_M_PI ) ), ( r1 * sin( GR_M_PI ) ) );
  //     m_8psk[ 1 ] = gr_complex( ( r2 * cos( GR_M_PI * 1.352 ) ),
  //                               ( r2 * sin( GR_M_PI * 1.352 ) ) );
  //     m_8psk[ 2 ] = gr_complex( ( r2 * cos( GR_M_PI * -1.352 ) ),
  //                               ( r2 * sin( GR_M_PI * -1.352 ) ) );
  //     m_8psk[ 3 ] =
  //         gr_complex( ( r3 * cos( GR_M_PI ) ), ( r3 * sin( GR_M_PI ) ) );
  //     m_8psk[ 4 ] = gr_complex( ( r1 * cos( 0.0 ) ), ( r1 * sin( 0.0 ) ) );
  //     m_8psk[ 5 ] = gr_complex( ( r2 * cos( GR_M_PI * -0.352 ) ),
  //                               ( r2 * sin( GR_M_PI * -0.352 ) ) );
  //     m_8psk[ 6 ] = gr_complex( ( r2 * cos( GR_M_PI * 0.352 ) ),
  //                               ( r2 * sin( GR_M_PI * 0.352 ) ) );
  ...
  //     r1 *= r0;
  //     r2 *= r0;
  //     m_16apsk[ 0 ] = gr_complex( ( r2 * cos( GR_M_PI / 4.0 ) ),
  //                                 ( r2 * sin( GR_M_PI / 4.0 ) ) );
  //     m_16apsk[ 1 ] = gr_complex( ( r2 * cos( -GR_M_PI / 4.0 ) ),
  //                                 ( r2 * sin( -GR_M_PI / 4.0 ) ) );
  //     m_16apsk[ 2 ] = gr_complex( ( r2 * cos( 3 * GR_M_PI / 4.0 ) ),
  //                                 ( r2 * sin( 3 * GR_M_PI / 4.0 ) ) );
  //     m_16apsk[ 3 ] = gr_complex( ( r2 * cos( -3 * GR_M_PI / 4.0 ) ),
  //                                 ( r2 * sin( -3 * GR_M_PI / 4.0 ) ) );
  //     m_16apsk[ 4 ] = gr_complex( ( r2 * cos( GR_M_PI / 12.0 ) ),
  //                                 ( r2 * sin( GR_M_PI / 12.0 ) ) );
  //     m_16apsk[ 5 ] = gr_complex( ( r2 * cos( -GR_M_PI / 12.0 ) ),
  //                                 ( r2 * sin( -GR_M_PI / 12.0 ) ) );
  //     m_16apsk[ 6 ] = gr_complex( ( r2 * cos( 11 * GR_M_PI / 12.0 ) ),
  //                                 ( r2 * sin( 11 * GR_M_PI / 12.0 ) ) );
  //     m_16apsk[ 7 ] = gr_complex( ( r2 * cos( -11 * GR_M_PI / 12.0 ) ),
  //                                 ( r2 * sin( -11 * GR_M_PI / 12.0 ) ) );
  //     m_16apsk[ 8 ] = gr_complex( ( r2 * cos( 5 * GR_M_PI / 12.0 ) ),
  //                                 ( r2 * sin( 5 * GR_M_PI / 12.0 ) ) );
  //     m_16apsk[ 9 ] = gr_complex( ( r2 * cos( -5 * GR_M_PI / 12.0 ) ),
  //                                 ( r2 * sin( -5 * GR_M_PI / 12.0 ) ) );
  //     m_16apsk[ 10 ] = gr_complex( ( r2 * cos( 7 * GR_M_PI / 12.0 ) ),
  //                                  ( r2 * sin( 7 * GR_M_PI / 12.0 ) ) );
  //     m_16apsk[ 11 ] = gr_complex( ( r2 * cos( -7 * GR_M_PI / 12.0 ) ),
  //                                  ( r2 * sin( -7 * GR_M_PI / 12.0 ) ) );
  //     m_16apsk[ 12 ] = gr_complex( ( r1 * cos( GR_M_PI / 4.0 ) ),
  //                                  ( r1 * sin( GR_M_PI / 4.0 ) ) );
  //     m_16apsk[ 13 ] = gr_complex( ( r1 * cos( -GR_M_PI / 4.0 ) ),
  //                                  ( r1 * sin( -GR_M_PI / 4.0 ) ) );
  //     m_16apsk[ 14 ] = gr_complex( ( r1 * cos( 3 * GR_M_PI / 4.0 ) ),
  //                                  ( r1 * sin( 3 * GR_M_PI / 4.0 ) ) );
  //     m_16apsk[ 15 ] = gr_complex( ( r1 * cos( -3 * GR_M_PI / 4.0 ) ),
  //                                  ( r1 * sin( -3 * GR_M_PI / 4.0 ) ) );
  //     break;
  //   case MOD_8_8APSK:
  //     if ( rate == C18_30 ) {
  ...
  //           break;
  //       }
  //       m_16apsk[ 0 ] = gr_complex( ( r1 * cos( GR_M_PI / 8.0 ) ),
  //                                   ( r1 * sin( GR_M_PI / 8.0 ) ) );
  //       m_16apsk[ 1 ] = gr_complex( ( r1 * cos( 3 * GR_M_PI / 8.0 ) ),
  //                                   ( r1 * sin( 3 * GR_M_PI / 8.0 ) ) );
  //       m_16apsk[ 2 ] = gr_complex( ( r1 * cos( 7 * GR_M_PI / 8.0 ) ),
  //                                   ( r1 * sin( 7 * GR_M_PI / 8.0 ) ) );
  //       m_16apsk[ 3 ] = gr_complex( ( r1 * cos( 5 * GR_M_PI / 8.0 ) ),
  //                                   ( r1 * sin( 5 * GR_M_PI / 8.0 ) ) );
  ...
  //       m_16apsk[ 6 ] = gr_complex( ( r1 * cos( 9 * GR_M_PI / 8.0 ) ),
  //                                   ( r1 * sin( 9 * GR_M_PI / 8.0 ) ) );
  //       m_16apsk[ 7 ] = gr_complex( ( r1 * cos( 11 * GR_M_PI / 8.0 ) ),
  //                                   ( r1 * sin( 11 * GR_M_PI / 8.0 ) ) );
  //       m_16apsk[ 8 ] = gr_complex( ( r2 * cos( GR_M_PI / 8.0 ) ),
  //                                   ( r2 * sin( GR_M_PI / 8.0 ) ) );
  //       m_16apsk[ 9 ] = gr_complex( ( r2 * cos( 3 * GR_M_PI / 8.0 ) ),
  //                                   ( r2 * sin( 3 * GR_M_PI / 8.0 ) ) );
  //       m_16apsk[ 10 ] = gr_complex( ( r2 * cos( 7 * GR_M_PI / 8.0 ) ),
  //                                    ( r2 * sin( 7 * GR_M_PI / 8.0 ) ) );
  //       m_16apsk[ 11 ] = gr_complex( ( r2 * cos( 5 * GR_M_PI / 8.0 ) ),
  //                                    ( r2 * sin( 5 * GR_M_PI / 8.0 ) ) );
  ...
  //       m_16apsk[ 14 ] = gr_complex( ( r2 * cos( 9 * GR_M_PI / 8.0 ) ),
  //                                    ( r2 * sin( 9 * GR_M_PI / 8.0 ) ) );
  ...
  //     r2 *= r0;
  //     r3 *= r0;
  //     m_32apsk[ 0 ] = gr_complex( ( r2 * cos( GR_M_PI / 4.0 ) ),
  //                                 ( r2 * sin( GR_M_PI / 4.0 ) ) );
  //     m_32apsk[ 1 ] = gr_complex( ( r2 * cos( 5 * GR_M_PI / 12.0 ) ),
  //                                 ( r2 * sin( 5 * GR_M_PI / 12.0 ) ) );
  //     m_32apsk[ 2 ] = gr_complex( ( r2 * cos( -GR_M_PI / 4.0 ) ),
  //                                 ( r2 * sin( -GR_M_PI / 4.0 ) ) );
  //     m_32apsk[ 3 ] = gr_complex( ( r2 * cos( -5 * GR_M_PI / 12.0 ) ),
  //                                 ( r2 * sin( -5 * GR_M_PI / 12.0 ) ) );
  //     m_32apsk[ 4 ] = gr_complex( ( r2 * cos( 3 * GR_M_PI / 4.0 ) ),
  //                                 ( r2 * sin( 3 * GR_M_PI / 4.0 ) ) );
  //     m_32apsk[ 5 ] = gr_complex( ( r2 * cos( 7 * GR_M_PI / 12.0 ) ),
  //                                 ( r2 * sin( 7 * GR_M_PI / 12.0 ) ) );
  //     m_32apsk[ 6 ] = gr_complex( ( r2 * cos( -3 * GR_M_PI / 4.0 ) ),
  //                                 ( r2 * sin( -3 * GR_M_PI / 4.0 ) ) );
  //     m_32apsk[ 7 ] = gr_complex( ( r2 * cos( -7 * GR_M_PI / 12.0 ) ),
  //                                 ( r2 * sin( -7 * GR_M_PI / 12.0 ) ) );
  //     m_32apsk[ 8 ] = gr_complex( ( r3 * cos( GR_M_PI / 8.0 ) ),
  //                                 ( r3 * sin( GR_M_PI / 8.0 ) ) );
  //     m_32apsk[ 9 ] = gr_complex( ( r3 * cos( 3 * GR_M_PI / 8.0 ) ),
  //                                 ( r3 * sin( 3 * GR_M_PI / 8.0 ) ) );
  //     m_32apsk[ 10 ] = gr_complex( ( r3 * cos( -GR_M_PI / 4.0 ) ),
  //                                  ( r3 * sin( -GR_M_PI / 4.0 ) ) );
  //     m_32apsk[ 11 ] = gr_complex( ( r3 * cos( -GR_M_PI / 2.0 ) ),
  //                                  ( r3 * sin( -GR_M_PI / 2.0 ) ) );
  //     m_32apsk[ 12 ] = gr_complex( ( r3 * cos( 3 * GR_M_PI / 4.0 ) ),
  //                                  ( r3 * sin( 3 * GR_M_PI / 4.0 ) ) );
  //     m_32apsk[ 13 ] = gr_complex( ( r3 * cos( GR_M_PI / 2.0 ) ),
  //                                  ( r3 * sin( GR_M_PI / 2.0 ) ) );
  //     m_32apsk[ 14 ] = gr_complex( ( r3 * cos( -7 * GR_M_PI / 8.0 ) ),
  //                                  ( r3 * sin( -7 * GR_M_PI / 8.0 ) ) );
  //     m_32apsk[ 15 ] = gr_complex( ( r3 * cos( -5 * GR_M_PI / 8.0 ) ),
  //                                  ( r3 * sin( -5 * GR_M_PI / 8.0 ) ) );
  //     m_32apsk[ 16 ] = gr_complex( ( r2 * cos( GR_M_PI / 12.0 ) ),
  //                                  ( r2 * sin( GR_M_PI / 12.0 ) ) );
  //     m_32apsk[ 17 ] = gr_complex( ( r1 * cos( GR_M_PI / 4.0 ) ),
  //                                  ( r1 * sin( GR_M_PI / 4.0 ) ) );
  //     m_32apsk[ 18 ] = gr_complex( ( r2 * cos( -GR_M_PI / 12.0 ) ),
  //                                  ( r2 * sin( -GR_M_PI / 12.0 ) ) );
  //     m_32apsk[ 19 ] = gr_complex( ( r1 * cos( -GR_M_PI / 4.0 ) ),
  //                                  ( r1 * sin( -GR_M_PI / 4.0 ) ) );
  //     m_32apsk[ 20 ] = gr_complex( ( r2 * cos( 11 * GR_M_PI / 12.0 ) ),
  //                                  ( r2 * sin( 11 * GR_M_PI / 12.0 ) ) );
  //     m_32apsk[ 21 ] = gr_complex( ( r1 * cos( 3 * GR_M_PI / 4.0 ) ),
  //                                  ( r1 * sin( 3 * GR_M_PI / 4.0 ) ) );
  //     m_32apsk[ 22 ] = gr_complex( ( r2 * cos( -11 * GR_M_PI / 12.0 ) ),
  //                                  ( r2 * sin( -11 * GR_M_PI / 12.0 ) ) );
  //     m_32apsk[ 23 ] = gr_complex( ( r1 * cos( -3 * GR_M_PI / 4.0 ) ),
  //                                  ( r1 * sin( -3 * GR_M_PI / 4.0 ) ) );
  //     m_32apsk[ 24 ] = gr_complex( ( r3 * cos( 0.0 ) ), ( r3 * sin( 0.0 ) )
  //     ); m_32apsk[ 25 ] = gr_complex( ( r3 * cos( GR_M_PI / 4.0 ) ),
  //                                  ( r3 * sin( GR_M_PI / 4.0 ) ) );
  //     m_32apsk[ 26 ] = gr_complex( ( r3 * cos( -GR_M_PI / 8.0 ) ),
  //                                  ( r3 * sin( -GR_M_PI / 8.0 ) ) );
  //     m_32apsk[ 27 ] = gr_complex( ( r3 * cos( -3 * GR_M_PI / 8.0 ) ),
  //                                  ( r3 * sin( -3 * GR_M_PI / 8.0 ) ) );
  //     m_32apsk[ 28 ] = gr_complex( ( r3 * cos( 7 * GR_M_PI / 8.0 ) ),
  //                                  ( r3 * sin( 7 * GR_M_PI / 8.0 ) ) );
  //     m_32apsk[ 29 ] = gr_complex( ( r3 * cos( 5 * GR_M_PI / 8.0 ) ),
  //                                  ( r3 * sin( 5 * GR_M_PI / 8.0 ) ) );
  //     m_32apsk[ 30 ] =
  //         gr_complex( ( r3 * cos( GR_M_PI ) ), ( r3 * sin( GR_M_PI ) ) );
  //     m_32apsk[ 31 ] = gr_complex( ( r3 * cos( -3 * GR_M_PI / 4.0 ) ),
  //                                  ( r3 * sin( -3 * GR_M_PI / 4.0 ) ) );
  //     break;
  ...
  //       }
  //     }
  //     m_32apsk[ 0 ] = gr_complex( ( r3 * cos( 11 * GR_M_PI / 16.0 ) ),
  //                                 ( r3 * sin( 11 * GR_M_PI / 16.0 ) ) );
  //     m_32apsk[ 1 ] = gr_complex( ( r3 * cos( 9 * GR_M_PI / 16.0 ) ),
  //                                 ( r3 * sin( 9 * GR_M_PI / 16.0 ) ) );
  //     m_32apsk[ 2 ] = gr_complex( ( r3 * cos( 5 * GR_M_PI / 16.0 ) ),
  //                                 ( r3 * sin( 5 * GR_M_PI / 16.0 ) ) );
  //     m_32apsk[ 3 ] = gr_complex( ( r3 * cos( 7 * GR_M_PI / 16.0 ) ),
  //                                 ( r3 * sin( 7 * GR_M_PI / 16.0 ) ) );
  //     m_32apsk[ 4 ] = gr_complex( ( r2 * cos( 3 * GR_M_PI / 4.0 ) ),
  //                                 ( r2 * sin( 3 * GR_M_PI / 4.0 ) ) );
  //     m_32apsk[ 5 ] = gr_complex( ( r2 * cos( 7 * GR_M_PI / 12.0 ) ),
  //                                 ( r2 * sin( 7 * GR_M_PI / 12.0 ) ) );
  //     m_32apsk[ 6 ] = gr_complex( ( r2 * cos( GR_M_PI / 4.0 ) ),
  //                                 ( r2 * sin( GR_M_PI / 4.0 ) ) );
  //     m_32apsk[ 7 ] = gr_complex( ( r2 * cos( 5 * GR_M_PI / 12.0 ) ),
  //                                 ( r2 * sin( 5 * GR_M_PI / 12.0 ) ) );
  //     m_32apsk[ 8 ] = gr_complex( ( r3 * cos( 13 * GR_M_PI / 16.0 ) ),
  //                                 ( r3 * sin( 13 * GR_M_PI / 16.0 ) ) );
  //     m_32apsk[ 9 ] = gr_complex( ( r3 * cos( 15 * GR_M_PI / 16.0 ) ),
  //                                 ( r3 * sin( 15 * GR_M_PI / 16.0 ) ) );
  //     m_32apsk[ 10 ] = gr_complex( ( r3 * cos( 3 * GR_M_PI / 16.0 ) ),
  //                                  ( r3 * sin( 3 * GR_M_PI / 16.0 ) ) );
  //     m_32apsk[ 11 ] = gr_complex( ( r3 * cos( GR_M_PI / 16.0 ) ),
  //                                  ( r3 * sin( GR_M_PI / 16.0 ) ) );
  //     m_32apsk[ 12 ] = gr_complex( ( r2 * cos( 11 * GR_M_PI / 12.0 ) ),
  //                                  ( r2 * sin( 11 * GR_M_PI / 12.0 ) ) );
  //     m_32apsk[ 13 ] = gr_complex( ( r1 * cos( 3 * GR_M_PI / 4.0 ) ),
  //                                  ( r1 * sin( 3 * GR_M_PI / 4.0 ) ) );
  //     m_32apsk[ 14 ] = gr_complex( ( r2 * cos( GR_M_PI / 12.0 ) ),
  //                                  ( r2 * sin( GR_M_PI / 12.0 ) ) );
  //     m_32apsk[ 15 ] = gr_complex( ( r1 * cos( GR_M_PI / 4.0 ) ),
  //                                  ( r1 * sin( GR_M_PI / 4.0 ) ) );
  //     m_32apsk[ 16 ] = gr_complex( ( r3 * cos( 21 * GR_M_PI / 16.0 ) ),
  //                                  ( r3 * sin( 21 * GR_M_PI / 16.0 ) ) );
  //     m_32apsk[ 17 ] = gr_complex( ( r3 * cos( 23 * GR_M_PI / 16.0 ) ),
  //                                  ( r3 * sin( 23 * GR_M_PI / 16.0 ) ) );
  //     m_32apsk[ 18 ] = gr_complex( ( r3 * cos( 27 * GR_M_PI / 16.0 ) ),
  //                                  ( r3 * sin( 27 * GR_M_PI / 16.0 ) ) );
  //     m_32apsk[ 19 ] = gr_complex( ( r3 * cos( 25 * GR_M_PI / 16.0 ) ),
  //                                  ( r3 * sin( 25 * GR_M_PI / 16.0 ) ) );
  //     m_32apsk[ 20 ] = gr_complex( ( r2 * cos( 5 * GR_M_PI / 4.0 ) ),
  //                                  ( r2 * sin( 5 * GR_M_PI / 4.0 ) ) );
  //     m_32apsk[ 21 ] = gr_complex( ( r2 * cos( 17 * GR_M_PI / 12.0 ) ),
  //                                  ( r2 * sin( 17 * GR_M_PI / 12.0 ) ) );
  //     m_32apsk[ 22 ] = gr_complex( ( r2 * cos( 7 * GR_M_PI / 4.0 ) ),
  //                                  ( r2 * sin( 7 * GR_M_PI / 4.0 ) ) );
  //     m_32apsk[ 23 ] = gr_complex( ( r2 * cos( 19 * GR_M_PI / 12.0 ) ),
  //                                  ( r2 * sin( 19 * GR_M_PI / 12.0 ) ) );
  //     m_32apsk[ 24 ] = gr_complex( ( r3 * cos( 19 * GR_M_PI / 16.0 ) ),
  //                                  ( r3 * sin( 19 * GR_M_PI / 16.0 ) ) );
  //     m_32apsk[ 25 ] = gr_complex( ( r3 * cos( 17 * GR_M_PI / 16.0 ) ),
  //                                  ( r3 * sin( 17 * GR_M_PI / 16.0 ) ) );
  //     m_32apsk[ 26 ] = gr_complex( ( r3 * cos( 29 * GR_M_PI / 16.0 ) ),
  //                                  ( r3 * sin( 29 * GR_M_PI / 16.0 ) ) );
  //     m_32apsk[ 27 ] = gr_complex( ( r3 * cos( 31 * GR_M_PI / 16.0 ) ),
  //                                  ( r3 * sin( 31 * GR_M_PI / 16.0 ) ) );
  //     m_32apsk[ 28 ] = gr_complex( ( r2 * cos( 13 * GR_M_PI / 12.0 ) ),
  //                                  ( r2 * sin( 13 * GR_M_PI / 12.0 ) ) );
  //     m_32apsk[ 29 ] = gr_complex( ( r1 * cos( 5 * GR_M_PI / 4.0 ) ),
  //                                  ( r1 * sin( 5 * GR_M_PI / 4.0 ) ) );
  //     m_32apsk[ 30 ] = gr_complex( ( r2 * cos( 23 * GR_M_PI / 12.0 ) ),
  //                                  ( r2 * sin( 23 * GR_M_PI / 12.0 ) ) );
  //     m_32apsk[ 31 ] = gr_complex( ( r1 * cos( 7 * GR_M_PI / 4.0 ) ),
  //                                  ( r1 * sin( 7 * GR_M_PI / 4.0 ) ) );
  //     break;
  ...
  //         break;
  //     }
  //     m_32apsk[ 0 ] = gr_complex( ( r1 * cos( GR_M_PI / 4.0 ) ),
  //                                 ( r1 * sin( GR_M_PI / 4.0 ) ) );
  //     m_32apsk[ 1 ] = gr_complex( ( r4 * cos( 7 * GR_M_PI / 16.0 ) ),
  //                                 ( r4 * sin( 7 * GR_M_PI / 16.0 ) ) );
  //     m_32apsk[ 2 ] = gr_complex( ( r1 * cos( 7 * GR_M_PI / 4.0 ) ),
  //                                 ( r1 * sin( 7 * GR_M_PI / 4.0 ) ) );
  //     m_32apsk[ 3 ] = gr_complex( ( r4 * cos( 25 * GR_M_PI / 16.0 ) ),
  //                                 ( r4 * sin( 25 * GR_M_PI / 16.0 ) ) );
  //     m_32apsk[ 4 ] = gr_complex( ( r1 * cos( 3 * GR_M_PI / 4.0 ) ),
  //                                 ( r1 * sin( 3 * GR_M_PI / 4.0 ) ) );
  //     m_32apsk[ 5 ] = gr_complex( ( r4 * cos( 9 * GR_M_PI / 16.0 ) ),
  //                                 ( r4 * sin( 9 * GR_M_PI / 16.0 ) ) );
  //     m_32apsk[ 6 ] = gr_complex( ( r1 * cos( 5 * GR_M_PI / 4.0 ) ),
  //                                 ( r1 * sin( 5 * GR_M_PI / 4.0 ) ) );
  //     m_32apsk[ 7 ] = gr_complex( ( r4 * cos( 23 * GR_M_PI / 16.0 ) ),
  //                                 ( r4 * sin( 23 * GR_M_PI / 16.0 ) ) );
  //     m_32apsk[ 8 ] = gr_complex( ( r2 * cos( GR_M_PI / 12.0 ) ),
  //                                 ( r2 * sin( GR_M_PI / 12.0 ) ) );
  //     m_32apsk[ 9 ] = gr_complex( ( r4 * cos( GR_M_PI / 16.0 ) ),
  //                                 ( r4 * sin( GR_M_PI / 16.0 ) ) );
  //     m_32apsk[ 10 ] = gr_complex( ( r2 * cos( 23 * GR_M_PI / 12.0 ) ),
  //                                  ( r2 * sin( 23 * GR_M_PI / 12.0 ) ) );
  //     m_32apsk[ 11 ] = gr_complex( ( r4 * cos( 31 * GR_M_PI / 16.0 ) ),
  //                                  ( r4 * sin( 31 * GR_M_PI / 16.0 ) ) );
  //     m_32apsk[ 12 ] = gr_complex( ( r2 * cos( 11 * GR_M_PI / 12.0 ) ),
  //                                  ( r2 * sin( 11 * GR_M_PI / 12.0 ) ) );
  //     m_32apsk[ 13 ] = gr_complex( ( r4 * cos( 15 * GR_M_PI / 16.0 ) ),
  //                                  ( r4 * sin( 15 * GR_M_PI / 16.0 ) ) );
  //     m_32apsk[ 14 ] = gr_complex( ( r2 * cos( 13 * GR_M_PI / 12.0 ) ),
  //                                  ( r2 * sin( 13 * GR_M_PI / 12.0 ) ) );
  //     m_32apsk[ 15 ] = gr_complex( ( r4 * cos( 17 * GR_M_PI / 16.0 ) ),
  //                                  ( r4 * sin( 17 * GR_M_PI / 16.0 ) ) );
  //     m_32apsk[ 16 ] = gr_complex( ( r2 * cos( 5 * GR_M_PI / 12.0 ) ),
  //                                  ( r2 * sin( 5 * GR_M_PI / 12.0 ) ) );
  //     m_32apsk[ 17 ] = gr_complex( ( r4 * cos( 5 * GR_M_PI / 16.0 ) ),
  //                                  ( r4 * sin( 5 * GR_M_PI / 16.0 ) ) );
  //     m_32apsk[ 18 ] = gr_complex( ( r2 * cos( 19 * GR_M_PI / 12.0 ) ),
  //                                  ( r2 * sin( 19 * GR_M_PI / 12.0 ) ) );
  //     m_32apsk[ 19 ] = gr_complex( ( r4 * cos( 27 * GR_M_PI / 16.0 ) ),
  //                                  ( r4 * sin( 27 * GR_M_PI / 16.0 ) ) );
  //     m_32apsk[ 20 ] = gr_complex( ( r2 * cos( 7 * GR_M_PI / 12.0 ) ),
  //                                  ( r2 * sin( 7 * GR_M_PI / 12.0 ) ) );
  //     m_32apsk[ 21 ] = gr_complex( ( r4 * cos( 11 * GR_M_PI / 16.0 ) ),
  //                                  ( r4 * sin( 11 * GR_M_PI / 16.0 ) ) );
  //     m_32apsk[ 22 ] = gr_complex( ( r2 * cos( 17 * GR_M_PI / 12.0 ) ),
  //                                  ( r2 * sin( 17 * GR_M_PI / 12.0 ) ) );
  //     m_32apsk[ 23 ] = gr_complex( ( r4 * cos( 21 * GR_M_PI / 16.0 ) ),
  //                                  ( r4 * sin( 21 * GR_M_PI / 16.0 ) ) );
  //     m_32apsk[ 24 ] = gr_complex( ( r3 * cos( GR_M_PI / 4.0 ) ),
  //                                  ( r3 * sin( GR_M_PI / 4.0 ) ) );
  //     m_32apsk[ 25 ] = gr_complex( ( r4 * cos( 3 * GR_M_PI / 16.0 ) ),
  //                                  ( r4 * sin( 3 * GR_M_PI / 16.0 ) ) );
  //     m_32apsk[ 26 ] = gr_complex( ( r3 * cos( 7 * GR_M_PI / 4.0 ) ),
  //                                  ( r3 * sin( 7 * GR_M_PI / 4.0 ) ) );
  //     m_32apsk[ 27 ] = gr_complex( ( r4 * cos( 29 * GR_M_PI / 16.0 ) ),
  //                                  ( r4 * sin( 29 * GR_M_PI / 16.0 ) ) );
  //     m_32apsk[ 28 ] = gr_complex( ( r3 * cos( 3 * GR_M_PI / 4.0 ) ),
  //                                  ( r3 * sin( 3 * GR_M_PI / 4.0 ) ) );
  //     m_32apsk[ 29 ] = gr_complex( ( r4 * cos( 13 * GR_M_PI / 16.0 ) ),
  //                                  ( r4 * sin( 13 * GR_M_PI / 16.0 ) ) );
  //     m_32apsk[ 30 ] = gr_complex( ( r3 * cos( 5 * GR_M_PI / 4.0 ) ),
  //                                  ( r3 * sin( 5 * GR_M_PI / 4.0 ) ) );
  //     m_32apsk[ 31 ] = gr_complex( ( r4 * cos( 19 * GR_M_PI / 16.0 ) ),
  //                                  ( r4 * sin( 19 * GR_M_PI / 16.0 ) ) );
  //     break;
  //   case MOD_64APSK:
  //     r4 = m;
  //     switch ( rate ) {
  ...
  //         break;
  //     }
  //     m_64apsk[ 0 ] = gr_complex( ( r1 * cos( GR_M_PI / 16.0 ) ),
  //                                 ( r1 * sin( GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 1 ] = gr_complex( ( r1 * cos( 3 * GR_M_PI / 16.0 ) ),
  //                                 ( r1 * sin( 3 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 2 ] = gr_complex( ( r1 * cos( 7 * GR_M_PI / 16.0 ) ),
  //                                 ( r1 * sin( 7 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 3 ] = gr_complex( ( r1 * cos( 5 * GR_M_PI / 16.0 ) ),
  //                                 ( r1 * sin( 5 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 4 ] = gr_complex( ( r1 * cos( 15 * GR_M_PI / 16.0 ) ),
  //                                 ( r1 * sin( 15 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 5 ] = gr_complex( ( r1 * cos( 13 * GR_M_PI / 16.0 ) ),
  //                                 ( r1 * sin( 13 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 6 ] = gr_complex( ( r1 * cos( 9 * GR_M_PI / 16.0 ) ),
  //                                 ( r1 * sin( 9 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 7 ] = gr_complex( ( r1 * cos( 11 * GR_M_PI / 16.0 ) ),
  //                                 ( r1 * sin( 11 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 8 ] = gr_complex( ( r1 * cos( 31 * GR_M_PI / 16.0 ) ),
  //                                 ( r1 * sin( 31 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 9 ] = gr_complex( ( r1 * cos( 29 * GR_M_PI / 16.0 ) ),
  //                                 ( r1 * sin( 29 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 10 ] = gr_complex( ( r1 * cos( 25 * GR_M_PI / 16.0 ) ),
  //                                  ( r1 * sin( 25 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 11 ] = gr_complex( ( r1 * cos( 27 * GR_M_PI / 16.0 ) ),
  //                                  ( r1 * sin( 27 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 12 ] = gr_complex( ( r1 * cos( 17 * GR_M_PI / 16.0 ) ),
  //                                  ( r1 * sin( 17 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 13 ] = gr_complex( ( r1 * cos( 19 * GR_M_PI / 16.0 ) ),
  //                                  ( r1 * sin( 19 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 14 ] = gr_complex( ( r1 * cos( 23 * GR_M_PI / 16.0 ) ),
  //                                  ( r1 * sin( 23 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 15 ] = gr_complex( ( r1 * cos( 21 * GR_M_PI / 16.0 ) ),
  //                                  ( r1 * sin( 21 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 16 ] = gr_complex( ( r2 * cos( GR_M_PI / 16.0 ) ),
  //                                  ( r2 * sin( GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 17 ] = gr_complex( ( r2 * cos( 3 * GR_M_PI / 16.0 ) ),
  //                                  ( r2 * sin( 3 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 18 ] = gr_complex( ( r2 * cos( 7 * GR_M_PI / 16.0 ) ),
  //                                  ( r2 * sin( 7 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 19 ] = gr_complex( ( r2 * cos( 5 * GR_M_PI / 16.0 ) ),
  //                                  ( r2 * sin( 5 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 20 ] = gr_complex( ( r2 * cos( 15 * GR_M_PI / 16.0 ) ),
  //                                  ( r2 * sin( 15 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 21 ] = gr_complex( ( r2 * cos( 13 * GR_M_PI / 16.0 ) ),
  //                                  ( r2 * sin( 13 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 22 ] = gr_complex( ( r2 * cos( 9 * GR_M_PI / 16.0 ) ),
  //                                  ( r2 * sin( 9 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 23 ] = gr_complex( ( r2 * cos( 11 * GR_M_PI / 16.0 ) ),
  //                                  ( r2 * sin( 11 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 24 ] = gr_complex( ( r2 * cos( 31 * GR_M_PI / 16.0 ) ),
  //                                  ( r2 * sin( 31 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 25 ] = gr_complex( ( r2 * cos( 29 * GR_M_PI / 16.0 ) ),
  //                                  ( r2 * sin( 29 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 26 ] = gr_complex( ( r2 * cos( 25 * GR_M_PI / 16.0 ) ),
  //                                  ( r2 * sin( 25 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 27 ] = gr_complex( ( r2 * cos( 27 * GR_M_PI / 16.0 ) ),
  //                                  ( r2 * sin( 27 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 28 ] = gr_complex( ( r2 * cos( 17 * GR_M_PI / 16.0 ) ),
  //                                  ( r2 * sin( 17 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 29 ] = gr_complex( ( r2 * cos( 19 * GR_M_PI / 16.0 ) ),
  //                                  ( r2 * sin( 19 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 30 ] = gr_complex( ( r2 * cos( 23 * GR_M_PI / 16.0 ) ),
  //                                  ( r2 * sin( 23 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 31 ] = gr_complex( ( r2 * cos( 21 * GR_M_PI / 16.0 ) ),
  //                                  ( r2 * sin( 21 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 32 ] = gr_complex( ( r4 * cos( GR_M_PI / 16.0 ) ),
  //                                  ( r4 * sin( GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 33 ] = gr_complex( ( r4 * cos( 3 * GR_M_PI / 16.0 ) ),
  //                                  ( r4 * sin( 3 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 34 ] = gr_complex( ( r4 * cos( 7 * GR_M_PI / 16.0 ) ),
  //                                  ( r4 * sin( 7 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 35 ] = gr_complex( ( r4 * cos( 5 * GR_M_PI / 16.0 ) ),
  //                                  ( r4 * sin( 5 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 36 ] = gr_complex( ( r4 * cos( 15 * GR_M_PI / 16.0 ) ),
  //                                  ( r4 * sin( 15 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 37 ] = gr_complex( ( r4 * cos( 13 * GR_M_PI / 16.0 ) ),
  //                                  ( r4 * sin( 13 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 38 ] = gr_complex( ( r4 * cos( 9 * GR_M_PI / 16.0 ) ),
  //                                  ( r4 * sin( 9 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 39 ] = gr_complex( ( r4 * cos( 11 * GR_M_PI / 16.0 ) ),
  //                                  ( r4 * sin( 11 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 40 ] = gr_complex( ( r4 * cos( 31 * GR_M_PI / 16.0 ) ),
  //                                  ( r4 * sin( 31 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 41 ] = gr_complex( ( r4 * cos( 29 * GR_M_PI / 16.0 ) ),
  //                                  ( r4 * sin( 29 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 42 ] = gr_complex( ( r4 * cos( 25 * GR_M_PI / 16.0 ) ),
  //                                  ( r4 * sin( 25 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 43 ] = gr_complex( ( r4 * cos( 27 * GR_M_PI / 16.0 ) ),
  //                                  ( r4 * sin( 27 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 44 ] = gr_complex( ( r4 * cos( 17 * GR_M_PI / 16.0 ) ),
  //                                  ( r4 * sin( 17 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 45 ] = gr_complex( ( r4 * cos( 19 * GR_M_PI / 16.0 ) ),
  //                                  ( r4 * sin( 19 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 46 ] = gr_complex( ( r4 * cos( 23 * GR_M_PI / 16.0 ) ),
  //                                  ( r4 * sin( 23 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 47 ] = gr_complex( ( r4 * cos( 21 * GR_M_PI / 16.0 ) ),
  //                                  ( r4 * sin( 21 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 48 ] = gr_complex( ( r3 * cos( GR_M_PI / 16.0 ) ),
  //                                  ( r3 * sin( GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 49 ] = gr_complex( ( r3 * cos( 3 * GR_M_PI / 16.0 ) ),
  //                                  ( r3 * sin( 3 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 50 ] = gr_complex( ( r3 * cos( 7 * GR_M_PI / 16.0 ) ),
  //                                  ( r3 * sin( 7 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 51 ] = gr_complex( ( r3 * cos( 5 * GR_M_PI / 16.0 ) ),
  //                                  ( r3 * sin( 5 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 52 ] = gr_complex( ( r3 * cos( 15 * GR_M_PI / 16.0 ) ),
  //                                  ( r3 * sin( 15 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 53 ] = gr_complex( ( r3 * cos( 13 * GR_M_PI / 16.0 ) ),
  //                                  ( r3 * sin( 13 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 54 ] = gr_complex( ( r3 * cos( 9 * GR_M_PI / 16.0 ) ),
  //                                  ( r3 * sin( 9 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 55 ] = gr_complex( ( r3 * cos( 11 * GR_M_PI / 16.0 ) ),
  //                                  ( r3 * sin( 11 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 56 ] = gr_complex( ( r3 * cos( 31 * GR_M_PI / 16.0 ) ),
  //                                  ( r3 * sin( 31 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 57 ] = gr_complex( ( r3 * cos( 29 * GR_M_PI / 16.0 ) ),
  //                                  ( r3 * sin( 29 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 58 ] = gr_complex( ( r3 * cos( 25 * GR_M_PI / 16.0 ) ),
  //                                  ( r3 * sin( 25 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 59 ] = gr_complex( ( r3 * cos( 27 * GR_M_PI / 16.0 ) ),
  //                                  ( r3 * sin( 27 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 60 ] = gr_complex( ( r3 * cos( 17 * GR_M_PI / 16.0 ) ),
  //                                  ( r3 * sin( 17 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 61 ] = gr_complex( ( r3 * cos( 19 * GR_M_PI / 16.0 ) ),
  //                                  ( r3 * sin( 19 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 62 ] = gr_complex( ( r3 * cos( 23 * GR_M_PI / 16.0 ) ),
  //                                  ( r3 * sin( 23 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 63 ] = gr_complex( ( r3 * cos( 21 * GR_M_PI / 16.0 ) ),
  //                                  ( r3 * sin( 21 * GR_M_PI / 16.0 ) ) );
  //     break;
  ...
  //         break;
  //     }
  //     m_64apsk[ 0 ] = gr_complex( ( r2 * cos( 25 * GR_M_PI / 16.0 ) ),
  //                                 ( r2 * sin( 25 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 1 ] = gr_complex( ( r4 * cos( 7 * GR_M_PI / 4.0 ) ),
  //                                 ( r4 * sin( 7 * GR_M_PI / 4.0 ) ) );
  //     m_64apsk[ 2 ] = gr_complex( ( r2 * cos( 27 * GR_M_PI / 16.0 ) ),
  //                                 ( r2 * sin( 27 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 3 ] = gr_complex( ( r3 * cos( 7 * GR_M_PI / 4.0 ) ),
  //                                 ( r3 * sin( 7 * GR_M_PI / 4.0 ) ) );
  //     m_64apsk[ 4 ] = gr_complex( ( r4 * cos( 31 * GR_M_PI / 20.0 ) ),
  //                                 ( r4 * sin( 31 * GR_M_PI / 20.0 ) ) );
  //     m_64apsk[ 5 ] = gr_complex( ( r4 * cos( 33 * GR_M_PI / 20.0 ) ),
  //                                 ( r4 * sin( 33 * GR_M_PI / 20.0 ) ) );
  //     m_64apsk[ 6 ] = gr_complex( ( r3 * cos( 31 * GR_M_PI / 20.0 ) ),
  //                                 ( r3 * sin( 31 * GR_M_PI / 20.0 ) ) );
  //     m_64apsk[ 7 ] = gr_complex( ( r3 * cos( 33 * GR_M_PI / 20.0 ) ),
  //                                 ( r3 * sin( 33 * GR_M_PI / 20.0 ) ) );
  //     m_64apsk[ 8 ] = gr_complex( ( r2 * cos( 23 * GR_M_PI / 16.0 ) ),
  //                                 ( r2 * sin( 23 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 9 ] = gr_complex( ( r4 * cos( 5 * GR_M_PI / 4.0 ) ),
  //                                 ( r4 * sin( 5 * GR_M_PI / 4.0 ) ) );
  //     m_64apsk[ 10 ] = gr_complex( ( r2 * cos( 21 * GR_M_PI / 16.0 ) ),
  //                                  ( r2 * sin( 21 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 11 ] = gr_complex( ( r3 * cos( 5 * GR_M_PI / 4.0 ) ),
  //                                  ( r3 * sin( 5 * GR_M_PI / 4.0 ) ) );
  //     m_64apsk[ 12 ] = gr_complex( ( r4 * cos( 29 * GR_M_PI / 20.0 ) ),
  ...
  //     m_64apsk[ 16 ] = gr_complex( ( r1 * cos( 13 * GR_M_PI / 8.0 ) ),
  //                                  ( r1 * sin( 13 * GR_M_PI / 8.0 ) ) );
  //     m_64apsk[ 17 ] = gr_complex( ( r4 * cos( 37 * GR_M_PI / 20.0 ) ),
  //                                  ( r4 * sin( 37 * GR_M_PI / 20.0 ) ) );
  //     m_64apsk[ 18 ] = gr_complex( ( r2 * cos( 29 * GR_M_PI / 16.0 ) ),
  //                                  ( r2 * sin( 29 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 19 ] = gr_complex( ( r3 * cos( 37 * GR_M_PI / 20.0 ) ),
  //                                  ( r3 * sin( 37 * GR_M_PI / 20.0 ) ) );
  //     m_64apsk[ 20 ] = gr_complex( ( r1 * cos( 15 * GR_M_PI / 8.0 ) ),
  //                                  ( r1 * sin( 15 * GR_M_PI / 8.0 ) ) );
  //     m_64apsk[ 21 ] = gr_complex( ( r4 * cos( 39 * GR_M_PI / 20.0 ) ),
  //                                  ( r4 * sin( 39 * GR_M_PI / 20.0 ) ) );
  //     m_64apsk[ 22 ] = gr_complex( ( r2 * cos( 31 * GR_M_PI / 16.0 ) ),
  //                                  ( r2 * sin( 31 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 23 ] = gr_complex( ( r3 * cos( 39 * GR_M_PI / 20.0 ) ),
  //                                  ( r3 * sin( 39 * GR_M_PI / 20.0 ) ) );
  //     m_64apsk[ 24 ] = gr_complex( ( r1 * cos( 11 * GR_M_PI / 8.0 ) ),
  //                                  ( r1 * sin( 11 * GR_M_PI / 8.0 ) ) );
  //     m_64apsk[ 25 ] = gr_complex( ( r4 * cos( 23 * GR_M_PI / 20.0 ) ),
  //                                  ( r4 * sin( 23 * GR_M_PI / 20.0 ) ) );
  //     m_64apsk[ 26 ] = gr_complex( ( r2 * cos( 19 * GR_M_PI / 16.0 ) ),
  //                                  ( r2 * sin( 19 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 27 ] = gr_complex( ( r3 * cos( 23 * GR_M_PI / 20.0 ) ),
  //                                  ( r3 * sin( 23 * GR_M_PI / 20.0 ) ) );
  //     m_64apsk[ 28 ] = gr_complex( ( r1 * cos( 9 * GR_M_PI / 8.0 ) ),
  //                                  ( r1 * sin( 9 * GR_M_PI / 8.0 ) ) );
  //     m_64apsk[ 29 ] = gr_complex( ( r4 * cos( 21 * GR_M_PI / 20.0 ) ),
  //                                  ( r4 * sin( 21 * GR_M_PI / 20.0 ) ) );
  //     m_64apsk[ 30 ] = gr_complex( ( r2 * cos( 17 * GR_M_PI / 16.0 ) ),
  //                                  ( r2 * sin( 17 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 31 ] = gr_complex( ( r3 * cos( 21 * GR_M_PI / 20.0 ) ),
  //                                  ( r3 * sin( 21 * GR_M_PI / 20.0 ) ) );
  //     m_64apsk[ 32 ] = gr_complex( ( r2 * cos( 7 * GR_M_PI / 16.0 ) ),
  //                                  ( r2 * sin( 7 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 33 ] = gr_complex( ( r4 * cos( GR_M_PI / 4.0 ) ),
  //                                  ( r4 * sin( GR_M_PI / 4.0 ) ) );
  //     m_64apsk[ 34 ] = gr_complex( ( r2 * cos( 5 * GR_M_PI / 16.0 ) ),
  //                                  ( r2 * sin( 5 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 35 ] = gr_complex( ( r3 * cos( GR_M_PI / 4.0 ) ),
  //                                  ( r3 * sin( GR_M_PI / 4.0 ) ) );
  //     m_64apsk[ 36 ] = gr_complex( ( r4 * cos( 9 * GR_M_PI / 20.0 ) ),
  //                                  ( r4 * sin( 9 * GR_M_PI / 20.0 ) ) );
  //     m_64apsk[ 37 ] = gr_complex( ( r4 * cos( 7 * GR_M_PI / 20.0 ) ),
  //                                  ( r4 * sin( 7 * GR_M_PI / 20.0 ) ) );
  //     m_64apsk[ 38 ] = gr_complex( ( r3 * cos( 9 * GR_M_PI / 20.0 ) ),
  //                                  ( r3 * sin( 9 * GR_M_PI / 20.0 ) ) );
  //     m_64apsk[ 39 ] = gr_complex( ( r3 * cos( 7 * GR_M_PI / 20.0 ) ),
  //                                  ( r3 * sin( 7 * GR_M_PI / 20.0 ) ) );
  //     m_64apsk[ 40 ] = gr_complex( ( r2 * cos( 9 * GR_M_PI / 16.0 ) ),
  //                                  ( r2 * sin( 9 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 41 ] = gr_complex( ( r4 * cos( 3 * GR_M_PI / 4.0 ) ),
  //                                  ( r4 * sin( 3 * GR_M_PI / 4.0 ) ) );
  //     m_64apsk[ 42 ] = gr_complex( ( r2 * cos( 11 * GR_M_PI / 16.0 ) ),
  //                                  ( r2 * sin( 11 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 43 ] = gr_complex( ( r3 * cos( 3 * GR_M_PI / 4.0 ) ),
  //                                  ( r3 * sin( 3 * GR_M_PI / 4.0 ) ) );
  //     m_64apsk[ 44 ] = gr_complex( ( r4 * cos( 11 * GR_M_PI / 20.0 ) ),
  //                                  ( r4 * sin( 11 * GR_M_PI / 20.0 ) ) );
  //     m_64apsk[ 45 ] = gr_complex( ( r4 * cos( 13 * GR_M_PI / 20.0 ) ),
  //                                  ( r4 * sin( 13 * GR_M_PI / 20.0 ) ) );
  //     m_64apsk[ 46 ] = gr_complex( ( r3 * cos( 11 * GR_M_PI / 20.0 ) ),
  //                                  ( r3 * sin( 11 * GR_M_PI / 20.0 ) ) );
  //     m_64apsk[ 47 ] = gr_complex( ( r3 * cos( 13 * GR_M_PI / 20.0 ) ),
  //                                  ( r3 * sin( 13 * GR_M_PI / 20.0 ) ) );
  //     m_64apsk[ 48 ] = gr_complex( ( r1 * cos( 3 * GR_M_PI / 8.0 ) ),
  //                                  ( r1 * sin( 3 * GR_M_PI / 8.0 ) ) );
  //     m_64apsk[ 49 ] = gr_complex( ( r4 * cos( 3 * GR_M_PI / 20.0 ) ),
  //                                  ( r4 * sin( 3 * GR_M_PI / 20.0 ) ) );
  //     m_64apsk[ 50 ] = gr_complex( ( r2 * cos( 3 * GR_M_PI / 16.0 ) ),
  //                                  ( r2 * sin( 3 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 51 ] = gr_complex( ( r3 * cos( 3 * GR_M_PI / 20.0 ) ),
  //                                  ( r3 * sin( 3 * GR_M_PI / 20.0 ) ) );
  //     m_64apsk[ 52 ] = gr_complex( ( r1 * cos( GR_M_PI / 8.0 ) ),
  //                                  ( r1 * sin( GR_M_PI / 8.0 ) ) );
  //     m_64apsk[ 53 ] = gr_complex( ( r4 * cos( GR_M_PI / 20.0 ) ),
  //                                  ( r4 * sin( GR_M_PI / 20.0 ) ) );
  //     m_64apsk[ 54 ] = gr_complex( ( r2 * cos( GR_M_PI / 16.0 ) ),
  //                                  ( r2 * sin( GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 55 ] = gr_complex( ( r3 * cos( GR_M_PI / 20.0 ) ),
  //                                  ( r3 * sin( GR_M_PI / 20.0 ) ) );
  //     m_64apsk[ 56 ] = gr_complex( ( r1 * cos( 5 * GR_M_PI / 8.0 ) ),
  //                                  ( r1 * sin( 5 * GR_M_PI / 8.0 ) ) );
  //     m_64apsk[ 57 ] = gr_complex( ( r4 * cos( 17 * GR_M_PI / 20.0 ) ),
  //                                  ( r4 * sin( 17 * GR_M_PI / 20.0 ) ) );
  //     m_64apsk[ 58 ] = gr_complex( ( r2 * cos( 13 * GR_M_PI / 16.0 ) ),
  //                                  ( r2 * sin( 13 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 59 ] = gr_complex( ( r3 * cos( 17 * GR_M_PI / 20.0 ) ),
  //                                  ( r3 * sin( 17 * GR_M_PI / 20.0 ) ) );
  //     m_64apsk[ 60 ] = gr_complex( ( r1 * cos( 7 * GR_M_PI / 8.0 ) ),
  //                                  ( r1 * sin( 7 * GR_M_PI / 8.0 ) ) );
  //     m_64apsk[ 61 ] = gr_complex( ( r4 * cos( 19 * GR_M_PI / 20.0 ) ),
  //                                  ( r4 * sin( 19 * GR_M_PI / 20.0 ) ) );
  //     m_64apsk[ 62 ] = gr_complex( ( r2 * cos( 15 * GR_M_PI / 16.0 ) ),
  //                                  ( r2 * sin( 15 * GR_M_PI / 16.0 ) ) );
  //     m_64apsk[ 63 ] = gr_complex( ( r3 * cos( 19 * GR_M_PI / 20.0 ) ),
  ...
  //         break;
  //     }
  //     m_64apsk[ 0 ] = gr_complex( ( r4 * cos( GR_M_PI / 4.0 ) ),
  //                                 ( r4 * sin( GR_M_PI / 4.0 ) ) );
  //     m_64apsk[ 1 ] = gr_complex( ( r4 * cos( 7 * GR_M_PI / 4.0 ) ),
  //                                 ( r4 * sin( 7 * GR_M_PI / 4.0 ) ) );
  //     m_64apsk[ 2 ] = gr_complex( ( r4 * cos( 3 * GR_M_PI / 4.0 ) ),
  //                                 ( r4 * sin( 3 * GR_M_PI / 4.0 ) ) );
  //     m_64apsk[ 3 ] = gr_complex( ( r4 * cos( 5 * GR_M_PI / 4.0 ) ),
  //                                 ( r4 * sin( 5 * GR_M_PI / 4.0 ) ) );
  //     m_64apsk[ 4 ] = gr_complex( ( r4 * cos( 13 * GR_M_PI / 28.0 ) ),
  //                                 ( r4 * sin( 13 * GR_M_PI / 28.0 ) ) );
  //     m_64apsk[ 5 ] = gr_complex( ( r4 * cos( 43 * GR_M_PI / 28.0 ) ),
  //                                 ( r4 * sin( 43 * GR_M_PI / 28.0 ) ) );
  //     m_64apsk[ 6 ] = gr_complex( ( r4 * cos( 15 * GR_M_PI / 28.0 ) ),
  //                                 ( r4 * sin( 15 * GR_M_PI / 28.0 ) ) );
  //     m_64apsk[ 7 ] = gr_complex( ( r4 * cos( 41 * GR_M_PI / 28.0 ) ),
  //                                 ( r4 * sin( 41 * GR_M_PI / 28.0 ) ) );
  //     m_64apsk[ 8 ] = gr_complex( ( r4 * cos( GR_M_PI / 28.0 ) ),
  //                                 ( r4 * sin( GR_M_PI / 28.0 ) ) );
  //     m_64apsk[ 9 ] = gr_complex( ( r4 * cos( 55 * GR_M_PI / 28.0 ) ),
  //                                 ( r4 * sin( 55 * GR_M_PI / 28.0 ) ) );
  //     m_64apsk[ 10 ] = gr_complex( ( r4 * cos( 27 * GR_M_PI / 28.0 ) ),
  //                                  ( r4 * sin( 27 * GR_M_PI / 28.0 ) ) );
  //     m_64apsk[ 11 ] = gr_complex( ( r4 * cos( 29 * GR_M_PI / 28.0 ) ),
  //                                  ( r4 * sin( 29 * GR_M_PI / 28.0 ) ) );
  //     m_64apsk[ 12 ] = gr_complex( ( r1 * cos( GR_M_PI / 4.0 ) ),
  //                                  ( r1 * sin( GR_M_PI / 4.0 ) ) );
  //     m_64apsk[ 13 ] = gr_complex( ( r1 * cos( 7 * GR_M_PI / 4.0 ) ),
  //                                  ( r1 * sin( 7 * GR_M_PI / 4.0 ) ) );
  //     m_64apsk[ 14 ] = gr_complex( ( r1 * cos( 3 * GR_M_PI / 4.0 ) ),
  //                                  ( r1 * sin( 3 * GR_M_PI / 4.0 ) ) );
  //     m_64apsk[ 15 ] = gr_complex( ( r1 * cos( 5 * GR_M_PI / 4.0 ) ),
  //                                  ( r1 * sin( 5 * GR_M_PI / 4.0 ) ) );
  //     m_64apsk[ 16 ] = gr_complex( ( r4 * cos( 9 * GR_M_PI / 28.0 ) ),
  //                                  ( r4 * sin( 9 * GR_M_PI / 28.0 ) ) );
  //     m_64apsk[ 17 ] = gr_complex( ( r4 * cos( 47 * GR_M_PI / 28.0 ) ),
  //                                  ( r4 * sin( 47 * GR_M_PI / 28.0 ) ) );
  //     m_64apsk[ 18 ] = gr_complex( ( r4 * cos( 19 * GR_M_PI / 28.0 ) ),
  //                                  ( r4 * sin( 19 * GR_M_PI / 28.0 ) ) );
  //     m_64apsk[ 19 ] = gr_complex( ( r4 * cos( 37 * GR_M_PI / 28.0 ) ),
  //                                  ( r4 * sin( 37 * GR_M_PI / 28.0 ) ) );
  //     m_64apsk[ 20 ] = gr_complex( ( r4 * cos( 11 * GR_M_PI / 28.0 ) ),
  //                                  ( r4 * sin( 11 * GR_M_PI / 28.0 ) ) );
  //     m_64apsk[ 21 ] = gr_complex( ( r4 * cos( 45 * GR_M_PI / 28.0 ) ),
  //                                  ( r4 * sin( 45 * GR_M_PI / 28.0 ) ) );
  //     m_64apsk[ 22 ] = gr_complex( ( r4 * cos( 17 * GR_M_PI / 28.0 ) ),
  //                                  ( r4 * sin( 17 * GR_M_PI / 28.0 ) ) );
  //     m_64apsk[ 23 ] = gr_complex( ( r4 * cos( 39 * GR_M_PI / 28.0 ) ),
  //                                  ( r4 * sin( 39 * GR_M_PI / 28.0 ) ) );
  //     m_64apsk[ 24 ] = gr_complex( ( r3 * cos( GR_M_PI / 20.0 ) ),
  //                                  ( r3 * sin( GR_M_PI / 20.0 ) ) );
  //     m_64apsk[ 25 ] = gr_complex( ( r3 * cos( 39 * GR_M_PI / 20.0 ) ),
  //                                  ( r3 * sin( 39 * GR_M_PI / 20.0 ) ) );
  //     m_64apsk[ 26 ] = gr_complex( ( r3 * cos( 19 * GR_M_PI / 20.0 ) ),
  //                                  ( r3 * sin( 19 * GR_M_PI / 20.0 ) ) );
  //     m_64apsk[ 27 ] = gr_complex( ( r3 * cos( 21 * GR_M_PI / 20.0 ) ),
  //                                  ( r3 * sin( 21 * GR_M_PI / 20.0 ) ) );
  //     m_64apsk[ 28 ] = gr_complex( ( r2 * cos( GR_M_PI / 12.0 ) ),
  //                                  ( r2 * sin( GR_M_PI / 12.0 ) ) );
  //     m_64apsk[ 29 ] = gr_complex( ( r2 * cos( 23 * GR_M_PI / 12.0 ) ),
  //                                  ( r2 * sin( 23 * GR_M_PI / 12.0 ) ) );
  //     m_64apsk[ 30 ] = gr_complex( ( r2 * cos( 11 * GR_M_PI / 12.0 ) ),
  //                                  ( r2 * sin( 11 * GR_M_PI / 12.0 ) ) );
  //     m_64apsk[ 31 ] = gr_complex( ( r2 * cos( 13 * GR_M_PI / 12.0 ) ),
  //                                  ( r2 * sin( 13 * GR_M_PI / 12.0 ) ) );
  //     m_64apsk[ 32 ] = gr_complex( ( r4 * cos( 5 * GR_M_PI / 28.0 ) ),
  //                                  ( r4 * sin( 5 * GR_M_PI / 28.0 ) ) );
  //     m_64apsk[ 33 ] = gr_complex( ( r4 * cos( 51 * GR_M_PI / 28.0 ) ),
  //                                  ( r4 * sin( 51 * GR_M_PI / 28.0 ) ) );
  //     m_64apsk[ 34 ] = gr_complex( ( r4 * cos( 23 * GR_M_PI / 28.0 ) ),
  //                                  ( r4 * sin( 23 * GR_M_PI / 28.0 ) ) );
  //     m_64apsk[ 35 ] = gr_complex( ( r4 * cos( 33 * GR_M_PI / 28.0 ) ),
  //                                  ( r4 * sin( 33 * GR_M_PI / 28.0 ) ) );
  //     m_64apsk[ 36 ] = gr_complex( ( r3 * cos( 9 * GR_M_PI / 20.0 ) ),
  //                                  ( r3 * sin( 9 * GR_M_PI / 20.0 ) ) );
  //     m_64apsk[ 37 ] = gr_complex( ( r3 * cos( 31 * GR_M_PI / 20.0 ) ),
  //                                  ( r3 * sin( 31 * GR_M_PI / 20.0 ) ) );
  //     m_64apsk[ 38 ] = gr_complex( ( r3 * cos( 11 * GR_M_PI / 20.0 ) ),
  //                                  ( r3 * sin( 11 * GR_M_PI / 20.0 ) ) );
  //     m_64apsk[ 39 ] = gr_complex( ( r3 * cos( 29 * GR_M_PI / 20.0 ) ),
  //                                  ( r3 * sin( 29 * GR_M_PI / 20.0 ) ) );
  //     m_64apsk[ 40 ] = gr_complex( ( r4 * cos( 3 * GR_M_PI / 28.0 ) ),
  //                                  ( r4 * sin( 3 * GR_M_PI / 28.0 ) ) );
  //     m_64apsk[ 41 ] = gr_complex( ( r4 * cos( 53 * GR_M_PI / 28.0 ) ),
  //                                  ( r4 * sin( 53 * GR_M_PI / 28.0 ) ) );
  //     m_64apsk[ 42 ] = gr_complex( ( r4 * cos( 25 * GR_M_PI / 28.0 ) ),
  //                                  ( r4 * sin( 25 * GR_M_PI / 28.0 ) ) );
  //     m_64apsk[ 43 ] = gr_complex( ( r4 * cos( 31 * GR_M_PI / 28.0 ) ),
  //                                  ( r4 * sin( 31 * GR_M_PI / 28.0 ) ) );
  //     m_64apsk[ 44 ] = gr_complex( ( r2 * cos( 5 * GR_M_PI / 12.0 ) ),
  //                                  ( r2 * sin( 5 * GR_M_PI / 12.0 ) ) );
  //     m_64apsk[ 45 ] = gr_complex( ( r2 * cos( 19 * GR_M_PI / 12.0 ) ),
  //                                  ( r2 * sin( 19 * GR_M_PI / 12.0 ) ) );
  //     m_64apsk[ 46 ] = gr_complex( ( r2 * cos( 7 * GR_M_PI / 12.0 ) ),
  //                                  ( r2 * sin( 7 * GR_M_PI / 12.0 ) ) );
  //     m_64apsk[ 47 ] = gr_complex( ( r2 * cos( 17 * GR_M_PI / 12.0 ) ),
  //                                  ( r2 * sin( 17 * GR_M_PI / 12.0 ) ) );
  //     m_64apsk[ 48 ] = gr_complex( ( r3 * cos( GR_M_PI / 4.0 ) ),
  //                                  ( r3 * sin( GR_M_PI / 4.0 ) ) );
  //     m_64apsk[ 49 ] = gr_complex( ( r3 * cos( 7 * GR_M_PI / 4.0 ) ),
  //                                  ( r3 * sin( 7 * GR_M_PI / 4.0 ) ) );
  //     m_64apsk[ 50 ] = gr_complex( ( r3 * cos( 3 * GR_M_PI / 4.0 ) ),
  //                                  ( r3 * sin( 3 * GR_M_PI / 4.0 ) ) );
  //     m_64apsk[ 51 ] = gr_complex( ( r3 * cos( 5 * GR_M_PI / 4.0 ) ),
  //                                  ( r3 * sin( 5 * GR_M_PI / 4.0 ) ) );
  //     m_64apsk[ 52 ] = gr_complex( ( r3 * cos( 7 * GR_M_PI / 20.0 ) ),
  //                                  ( r3 * sin( 7 * GR_M_PI / 20.0 ) ) );
  //     m_64apsk[ 53 ] = gr_complex( ( r3 * cos( 33 * GR_M_PI / 20.0 ) ),
  //                                  ( r3 * sin( 33 * GR_M_PI / 20.0 ) ) );
  //     m_64apsk[ 54 ] = gr_complex( ( r3 * cos( 13 * GR_M_PI / 20.0 ) ),
  //                                  ( r3 * sin( 13 * GR_M_PI / 20.0 ) ) );
  ...
  //                                  ( r3 * sin( 23 * GR_M_PI / 20.0 ) ) );
  //     m_64apsk[ 60 ] = gr_complex( ( r2 * cos( GR_M_PI / 4.0 ) ),
  //                                  ( r2 * sin( GR_M_PI / 4.0 ) ) );
  //     m_64apsk[ 61 ] = gr_complex( ( r2 * cos( 7 * GR_M_PI / 4.0 ) ),
  //                                  ( r2 * sin( 7 * GR_M_PI / 4.0 ) ) );
  //     m_64apsk[ 62 ] = gr_complex( ( r2 * cos( 3 * GR_M_PI / 4.0 ) ),
  //                                  ( r2 * sin( 3 * GR_M_PI / 4.0 ) ) );
  //     m_64apsk[ 63 ] = gr_complex( ( r2 * cos( 5 * GR_M_PI / 4.0 ) ),
  //                                  ( r2 * sin( 5 * GR_M_PI / 4.0 ) ) );
  //     break;
  //   case MOD_128APSK:
  //     r6 = m;
  ...
  //                                   );
  //     m_128apsk[ 18 ] = gr_complex( ( r6 * cos( 43 * GR_M_PI / 90.0 ) ),
  //                                   ( r6 * sin( 43 * GR_M_PI / 90.0 ) ) );
  ...
  //                                   );
  //     m_128apsk[ 50 ] = gr_complex( ( r6 * cos( 47 * GR_M_PI / 90.0 ) ),
  //                                   ( r6 * sin( 47 * GR_M_PI / 90.0 ) ) );
  ...
  //           break;
  //       }
  //       m_256apsk[ 0 ] = gr_complex( ( r1 * cos( GR_M_PI / 32.0 ) ),
  //                                    ( r1 * sin( GR_M_PI / 32.0 ) ) );
  ...
  //       m_256apsk[ 32 ] = gr_complex( ( r2 * cos( GR_M_PI / 32.0 ) ),
  //                                     ( r2 * sin( GR_M_PI / 32.0 ) ) );
  ...
  //       m_256apsk[ 64 ] = gr_complex( ( r4 * cos( GR_M_PI / 32.0 ) ),
  //                                     ( r4 * sin( GR_M_PI / 32.0 ) ) );
  ...
  //       m_256apsk[ 96 ] = gr_complex( ( r3 * cos( GR_M_PI / 32.0 ) ),
  //                                     ( r3 * sin( GR_M_PI / 32.0 ) ) );
  ...
  //       m_256apsk[ 128 ] = gr_complex( ( r8 * cos( GR_M_PI / 32.0 ) ),
  //                                      ( r8 * sin( GR_M_PI / 32.0 ) ) );
  ...
  //       m_256apsk[ 160 ] = gr_complex( ( r7 * cos( GR_M_PI / 32.0 ) ),
  //                                      ( r7 * sin( GR_M_PI / 32.0 ) ) );
  ...
  //       m_256apsk[ 192 ] = gr_complex( ( r5 * cos( GR_M_PI / 32.0 ) ),
  //                                      ( r5 * sin( GR_M_PI / 32.0 ) ) );
  ...
  //       m_256apsk[ 224 ] = gr_complex( ( r6 * cos( GR_M_PI / 32.0 ) ),
  //                                      ( r6 * sin( GR_M_PI / 32.0 ) ) );
  ...
  //     break;
  //   default:
  //     modulation_table[ 0 ] = gr_complex( ( r1 * cos( GR_M_PI / 4.0 ) ),
  //                                         ( r1 * sin( GR_M_PI / 4.0 ) ) );
  //     modulation_table[ 1 ] = gr_complex( ( r1 * cos( 7 * GR_M_PI / 4.0 ) ),
  //                                         ( r1 * sin( 7 * GR_M_PI / 4.0 ) )
  //                                         );
  //     modulation_table[ 2 ] = gr_complex( ( r1 * cos( 3 * GR_M_PI / 4.0 ) ),
  //                                         ( r1 * sin( 3 * GR_M_PI / 4.0 ) )
  //                                         );
  //     modulation_table[ 3 ] = gr_complex( ( r1 * cos( 5 * GR_M_PI / 4.0 ) ),
  //                                         ( r1 * sin( 5 * GR_M_PI / 4.0 ) )
  //                                         );
  //     break;
